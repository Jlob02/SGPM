...
<body>
  ...
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                ...
                <a href="/logout" class="text-white d-flex align-items-center"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class=" me-2 bi bi-box-arrow-left" viewBox="0 0 16 16">
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
            ...
            <div class="col-10 mt-3">
                <ul class="nav nav-tabs ">
                    ...
                    @endif
                    <li class="nav-item me-1 ">
                        @if (Request::path() =='fornecedores' or Request::path() =='adicionar-fornecedor')
                        <a class="nav-link text-black active" href="/fornecedores">Fornecedores</a>
                        @else
