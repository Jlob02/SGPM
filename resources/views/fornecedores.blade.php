                            ...
                            <tbody class="table-group-divider">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <button onclick='dialog("{{$fornecedor->id}}","{{$fornecedor->nome}}")' data-bs-toggle="tooltip" title="Remover" class=" border border-0 bg-transparent" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="red" class="bi bi-trash" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#exampleModal">
             ...
             @method('DELETE')
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Tem a certeza que quer apagar o fornecedor ` + nome + ` ?
                                    </div>
