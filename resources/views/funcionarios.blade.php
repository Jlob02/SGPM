        ...
        <div class="row">
            <div class="row">
                <div class="col-12 m-1 ">
                    <a href="/adicionar-funcionario" class="btn btn-primary">Adicionar funcionario</a>
                </div>
            </div>
            <div class="col-12">
                    ...
                    <div class="col-12 ">
                        <table class=" table-sm table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="p-1">{{$user->u_telemovel}}</td>
                                <td class="text-white"><a href="#" class="btn text-white rounded-3 btn-sm btn-success">ativo</a></td>
                                <td class="text-white"> <a href="#" class="btn text-white rounded-3 btn-sm btn-success">alterar</a> <a href="" class="btn text-white btn-sm rounded-3 btn-danger ">apagar</a></td>
                            </tr>
                            @endforeach
                        </table>
