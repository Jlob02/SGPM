                            ...
                            <tbody class="table-group-divider">
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex justify-content-around">
                                        ...
                                        <button onclick='dialog("{{$user->id}}","{{$user->u_nome}}")' class=" border border-0 bg-transparent" type="submit"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="red" class="bi bi-trash" viewBox="0 0 16 16" data-bs-toggle="modal" data-bs-target="#exampleModal">
