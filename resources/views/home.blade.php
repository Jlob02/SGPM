...
<div class="row mt-4">
    ...
    <div class="col-10">
        <div class="row">
            <div class="col-2">
                <div class="row  ">
                    <div class="col-12 rounded-top-2 m-1 p-2 _navbar text-white p-1 mt-1">
            ...
            <div class="col-10">
                <div class="row _navbar rounded-top-2 m-1 p-2">
                ...
                <div class="row p-1 _list">
                    <div class="col-12 ">
                        ...
                        <a href="https://google.com" class="row m-1 d-flex align-items-center _list_item">
                            <div class="col-11">
                                <div class="row">
                                    <div class="col-3">
                                        DESCRIÇÃO : DINPAC 84
                        ...
                        <div class="row m-1 d-flex align-items-center _list_item">
                            <div class="col-11">
                                <div class="row">
                                    <div class="col-3">
                                        DESCRIÇÃO : DINPAC 84
