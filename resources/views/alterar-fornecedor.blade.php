                ...
                <div class="row d-flex justify-content-center bg-white shadow m-1 _text m-1 p-5">
                    <div class="col-7 d-flex p-5">
                        <form class="row g-1" method="post" action="/fornecedores/alterar/{{$fornecedor->id}}">
                            ...
                            <div class="col-9">
                                <input type="text" name="pessoa_contacto" class="form-control bg-body-secondary" id="inputName" placeholder="Nome da pessoa de contacto" value='{{$fornecedor->pessoa_contacto}}' />
                            </div>
